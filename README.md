...
![Лицензия: Apache-2.0](https://img.shields.io/badge/License-Apache_2.0-blue)
![Python: 3.9+](https://img.shields.io/badge/Python-3.9%2B-blue)
![Зависимости: нет](https://img.shields.io/badge/dependencies-none-brightgreen)
![Тесты: 200+](https://img.shields.io/badge/tests-200%2B-brightgreen)
...
Тесты не требуют сети, внешней базы данных или Docker: только стандартная библиотека Python. В наборе более 200 тестов.
