...
![Лицензия: Apache-2.0](https://img.shields.io/badge/License-Apache_2.0-blue) ![Python: 3.9+](https://img.shields.io/badge/Python-3.9%2B-blue) ![Зависимости: нет](https://img.shields.io/badge/dependencies-none-brightgreen) ![Тесты: 428](https://img.shields.io/badge/tests-428-brightgreen)
...
**Самопроверка настроек.** На каждом старте ловит ошибки, которые ломают работу молча: опечатки в переопределениях надписей и в именах ключей, битые regex-шаблоны, даты не в ISO, а также расхождение с настройками самого Claude Code — движок смотрит не в ту папку, куда пишет авто-память, или авто-память выключена и уроки писать некому. Последнее важнее всего: снаружи это выглядит как «всё хорошо, уроков просто нет». Включён.
