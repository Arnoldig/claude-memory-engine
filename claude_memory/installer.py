...
HOOK_REGISTRATIONS: List[Tuple[str, str, str, int]] = [
    ...
    # Bash ДО выполнения: мягкие подсказки (ревью перед сохранением, формулировка
    # задачи). Ничего не блокируют — кладут текст в контекст и возвращают управление.
    ("PreToolUse", "Bash", "pre-bash-notice", 10),
