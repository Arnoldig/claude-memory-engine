...
# каталога» — им пользуются нудж записи урока (hooks_cli) и сводка здоровья
# (catalog_generate). Один источник истины нужен вот зачем: добавляя сюда новый алфавит,
# вы одновременно учите ретривер его индексировать И нудж про него говорить. Две отдельные
