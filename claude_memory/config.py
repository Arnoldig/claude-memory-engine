...
class MemoryConfig:
    ...
    # Нудж «высокий ярус поиска (name + keywords, ×2) пуст для языка каталога». Ручка
    ...
    # для каталога, который сознательно живёт без `keywords`: там нудж пришёл бы на КАЖДУЮ
