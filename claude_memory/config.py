...
class MemoryConfig:
    ...
    # Какие файлы считать инструкциями проекта — пути ОТНОСИТЕЛЬНО project_root.
    ...
    # ГРАНИЦА, НАЗВАННАЯ ВСЛУХ: обхода дерева каталогов вверх и вниз, как это делает сам
    # Claude Code, здесь НЕТ — стерегутся ровно перечисленные пути.
